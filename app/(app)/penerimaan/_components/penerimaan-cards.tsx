...
import { Wallet, CheckCircle2, Clock, Ban } from "lucide-react"
import { Card, CardContent } from "@/components/ui/card"
import type { PenerimaanSummary } from "@/app/actions/penerimaan"
import { cn } from "@/lib/utils"

const rupiah = (n: number) =>
  new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", maximumFractionDigits: 0 }).format(n)

interface PenerimaanCardsProps {
  summary: PenerimaanSummary
  activeStatus?: string
}

export function PenerimaanCards({ summary, activeStatus }: PenerimaanCardsProps) {
